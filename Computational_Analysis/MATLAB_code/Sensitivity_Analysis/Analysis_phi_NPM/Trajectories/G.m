...
% These are the fixed parameters for the 'G' simulation.
gamma = 0.5;
omega = 0.28;
phi_FS = 0.2;
m = 0.1;
...
initial_condition = [0.1 0.4]; % This is the new starting point 'G'
...
%%% --- Plot Annotations --- %%%
% Plot the initial starting point 'G' with a marker and a label
plot(initial_condition(1), initial_condition(2), 'ko', 'MarkerSize', 6, 'MarkerFaceColor', 'r');
text(initial_condition(1) - 0.04, initial_condition(2) + 0.02, 'G', 'FontSize', 13, ...
...
outputFileName = 'G.pdf'; % Changed filename to reflect the new plot
