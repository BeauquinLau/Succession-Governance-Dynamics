...
% These are the fixed parameters for the 'N' simulation.
gamma = 0.5;
omega = 0.28;
phi_FS = 0.2;
phi_NPM = 0.25;
...
initial_condition = [0.5 0.6]; % This is the new starting point 'N'
...
%%% --- Plot Annotations --- %%%
% Plot the initial starting point 'N' with a marker and a label
plot(initial_condition(1), initial_condition(2), 'ko', 'MarkerSize', 6, 'MarkerFaceColor', 'r');
text(initial_condition(1) - 0.04, initial_condition(2) - 0.05, 'N', 'FontSize', 13, ...
...
outputFileName = 'N.pdf'; % Changed filename to reflect the new plot
