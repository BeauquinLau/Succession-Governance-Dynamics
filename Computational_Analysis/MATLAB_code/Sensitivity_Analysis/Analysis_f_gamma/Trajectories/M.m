...
% These are the fixed parameters for the 'M' simulation.
gamma = 0.5;
omega = 0.28;
phi_FS = 0.2;
phi_NPM = 0.25;
...
initial_condition = [0.3 0.3]; % This is the new starting point 'M'
...
%%% --- Plot Annotations --- %%%
% Plot the initial starting point 'M' with a marker and a label
plot(initial_condition(1), initial_condition(2), 'ko', 'MarkerSize', 6, 'MarkerFaceColor', 'r');
text(initial_condition(1) - 0.04, initial_condition(2) + 0.02, 'M', 'FontSize', 13, ...
...
outputFileName = 'M.pdf'; % Changed filename to reflect the new plot
