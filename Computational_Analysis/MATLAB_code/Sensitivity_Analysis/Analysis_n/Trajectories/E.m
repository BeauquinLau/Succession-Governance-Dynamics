...
% These parameters are for the 'E' simulation.
gamma = 0.5;
omega = 0.2;
phi_FS = 0.05;
phi_NPM = 0.1;
...
initial_condition = [0.5 0.4]; % This is the new starting point 'E'
...
%%% --- Plot Annotations --- %%%
% Plot the initial starting point 'E' with a marker and a label
plot(initial_condition(1), initial_condition(2), 'ko', 'MarkerSize', 6, 'MarkerFaceColor', 'r');
text(initial_condition(1) + 0.02, initial_condition(2) + 0.03, 'E', 'FontSize', 13, ...
...
outputFileName = 'E.pdf'; % Changed filename to reflect the new plot
