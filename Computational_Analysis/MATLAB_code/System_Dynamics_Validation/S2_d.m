%%% === SCRIPT SETUP FOR S2 (Regime Shift Separatrix) === %%%
% --- Define System Parameters ---
% A parameter set that enables simultaneous stability of E2 and E3.
gamma = 0.5;
omega = 0.01;
phi_FS = 0.01;
phi_NPM = 0.25;
...
fprintf('Saddle point E5 for Regime Shift is at (p*, q*) = (%.4f, %.4f)\n', p_star, q_star);
...
% Integrate along UNSTABLE manifold (forward in time from E5)
...
% Integrate along STABLE manifold (backward in time from E5)
...
% --- Plot Annotations ---
% UPDATED stability colors: E2 and E3 are now green (stable)
...
title('Separatrix under Conflict: Basins for $E_2$ and $E_3$','Interpreter','latex');
